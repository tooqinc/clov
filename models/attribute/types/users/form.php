...
if(empty($options)) {
	echo $formHelper->selectMultiple($controller->field('value'), array('NULL' => t('No Acceptable Users')), null, array('disabled' => 'disabled'));
	...
	echo $formHelper->selectMultiple($controller->field('value'), $controller->getValueOptions(), $controller->getValue());
}
